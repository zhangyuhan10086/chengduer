    ...
    <div class="main">
      ...
      <div class="content">
        <div class="card" v-for="item in commentJson">
          ...
          <div class="say_what">
            在评论中<span style="color:#7fb8fb">@你： </span>{{item.commentfont}}
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      getCommentData() {
        ...
        query.find().then(results => {
          ...
          for (var i = 0; i < results.length; i++) {
            var data = {
              commentfont: results[i].commentfont,
      ...
      clearRemind() {
        ...
        query.get(localStorage.CDECY_REMINDID).then(remind => {
          // 查询成功，调用get方法获取对应属性的值
          //remind.fetchWhenSave(true);
          remind.set("aiteUnread", 0);
          remind.save();
        });
      },
    }
